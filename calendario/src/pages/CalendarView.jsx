    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] w-full gap-5">
        <div className="relative w-12 h-12">
          ...
          <div className="absolute inset-0 bg-gold rounded-full opacity-60 animate-ping" style={{ animationDelay: '-0.5s' }}></div>
        </div>
        <p className="text-gold font-bold text-lg tracking-wide animate-pulse">A carregar calendário...</p>
      </div>
    );
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                {Object.entries(eventTypes).map(([key, value]) => (
                  <option key={key} value={key} className="bg-cream dark:bg-dark text-dark dark:text-cream">
                    {value.label}
                  </option>
                ))}
              </select>
