      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex-shrink-0 flex items-center gap-3" onClick={closeMenu}>
            ...
            <span className="font-semibold text-lg hidden sm:block text-dark dark:text-cream">Calendário</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                <span className="text-sm font-medium text-dark/70 dark:text-cream/70">{user.email}</span>
                <button 
